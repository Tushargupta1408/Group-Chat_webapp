...
//page init:
//At this time we have to load messages.
...
function handleLogout(){
  ...
  return (
    <div className="">
{/* This is header */}
    <header className="dark:border-gray-700 px-10 h-20 dark:bg-gray-900 shadow border flex justify-around items-center fixed w-full">
        <div >
        {/* Room name container */}
   ...
   <button className="dark:bg-gray-500 h-10 w-10 flex justify-center items-center rounded-full">
   <MdAttachFile size={20}/>
   </button>
   <button onClick={sendMessge} className="dark:bg-blue-500 h-10 w-10 flex justify-center items-center rounded-full">
   <MdSend size={20}/>
   </button>
   </div>
