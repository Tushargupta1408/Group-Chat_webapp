...
import chaIcon from "../assets/chat.png"
...
const JoinCreateChat = () => {
   ...
   async function createRoom(){
        if(validateForm()){
            //create room
            console.log(detail);
            //call API to create room on back-end
            try {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
     <div className="p-10 dark:border-gray-700 border w-full flex flex-col gap-5 max-w-md rounded dark:bg-gray-900 shadow">
       <div>
        <img src={chaIcon} className="w-20 mx-auto"/>
       </div>
        ...
        <div className="flex justify-center gap-2 mt-2">
            ...
            <button onClick={createRoom} className="px-3 py-2 dark:bg-green-500 hover:dark:bg-green-800 rounded">Create Room</button>
        </div>
